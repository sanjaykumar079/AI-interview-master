  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            ...
            <a
        href="https://resume-ats-scan.streamlit.app/"
        className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-slate-800 hover:bg-primary focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">        ResumeATS Pro
      </a>
      <br></br>
      <a
        href="https://apphrinterview-ca9n2nbbfp4rjznvkwnidm.streamlit.app/"
        className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-slate-800 hover:bg-primary focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">        Apply for Job
      </a>
...
<a
      ...
      <div className="mt-6">
                <h1 className="text-2xl font-bold mb-4 text-primary">Practice Here</h1>
                <iframe 
                    frameBorder="0"
                    height="450px"
                    src="https://onecompiler.com/embed/" 
                    width="100%"
                    title="Coding Assessment Tool"
                    loading="lazy"
                ></iframe>
            </div>
