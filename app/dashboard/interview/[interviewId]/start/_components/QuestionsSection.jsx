     ...
     <Volume2 className='cursor-pointer' onClick={()=>textToSpeach(mockInterviewQuestion[activeQuestionIndex]?.Question || mockInterviewQuestion[activeQuestionIndex]?.question)}/>
      ...
      <div className='border rounded-lg p-5 bg-blue-100 mt-20'>
        <h2 className='flex gap-2 items-center text-blue-800'>
            <LightbulbIcon/>
            <strong>Note:**You Have to Answer all the Questions**
            Click on Record Answer When you when you answer the question. At the end of interview we will give you the feedback along with correct answer for each question and your answer to compare it.</strong>
        </h2>
