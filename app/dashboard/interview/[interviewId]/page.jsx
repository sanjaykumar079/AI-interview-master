...
const Interview = ({params}) => {
  ...
  return (
    ...
    <p>Maintain eye contact. Look directly into the camera when speaking, rather than at your own image on the screen.Speak clearly and confidently. Enunciate your words and avoid talking too quickly.If you encountered any technical difficulties during the interview, address them in your follow-up email and offer to provide any additional information if needed.Remember, an online interview is still a chance for you to showcase your skills and personality to potential employers.</p>
      ...
      <div className='flex justify-end items-end'>
        ...
        <Button className='bg-green-700'>Start Interview</Button>
        </Link>
